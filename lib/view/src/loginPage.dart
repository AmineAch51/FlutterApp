...
import 'package:flutterapp/model/SignVerifivationMethods.dart';
import 'package:flutterapp/model/auth_provider.dart';
import 'package:flutterapp/view/src/signup.dart';
...
class _LoginPageState extends State<LoginPage> {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          TextField(
              controller: isPassword?motDePasse:email,
  ...
  Future<bool> tryToConnect() async {
    bool v=await context.read<AuthProvider>().handleSignInEmail(email.text, motDePasse.text);
    if(v) {
      Navigator.pushNamed(context, "/MainMenu");
    }else {
      setState(() {
        afficherMessageErreurDansLeMotDePasse=true;
      });
    }
    return v;
  }
